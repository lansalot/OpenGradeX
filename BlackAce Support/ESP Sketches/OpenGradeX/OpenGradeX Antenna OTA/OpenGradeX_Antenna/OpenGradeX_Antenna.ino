/*
  ...
  * Using "ESP32 Dev Module" board
  * hold IO0 btn when Arduino IDE is ready to upload, release once it starts uploading
*/
#include <Arduino.h>
#include <WiFi.h>
#include "WiFiUdp.h"
...
IPAddress gatewayIP(192,168,1,1);   // ??? what we want the esp 32 IPAddress to be
